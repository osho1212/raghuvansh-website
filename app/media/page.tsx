          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
            <div className="bg-ink text-canvas border border-gold/20 p-8 hover:border-gold/60 transition-colors flex flex-col justify-between aspect-video rounded-sm">
              ...
              <div>
                ...
                <p className="font-body text-sm text-canvas/70 mb-6">A deep-dive interview with Pt. Amitosh Sharma on the historical significance of the Ramayan performances at the Red Fort.</p>
              </div>
