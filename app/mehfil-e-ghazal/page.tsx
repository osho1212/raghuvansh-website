            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-body text-lg text-canvas/80 leading-relaxed mb-6">
                  A Sangeet Natak Akademi awardee, Anushka Pandit has captivated audiences nationwide with her mesmerizing voice. She brings a contemporary depth to classical Ghazals, devotional music, and Sufi compositions, making these rich traditions accessible and emotional for listeners of all ages.
                </p>
              </div>
              <div>
