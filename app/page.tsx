          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="font-body text-lg text-ink/80 leading-relaxed mb-8">
                Raghuvansh Group of Performing Arts is a premier performing arts collective based in New Delhi. Founded by Pt. Amitosh Sharma, a renowned AIR B-high grade artist, we bring centuries of Indian theatrical tradition to the modern stage with unparalleled grandeur.
              </p>
