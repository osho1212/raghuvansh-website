...
export const productionsData: Production[] = [
  ...
  },
  {
    ...
    synopsisFull: [
      "Saari Raat transcends the boundaries of conventional theatre, emerging as a deeply philosophical exploration of loneliness, human relationships, and the timeless search for truth. Set over the course of a single night, the play transforms an ordinary encounter into an extraordinary journey of introspection, where every conversation, every silence, and every passing moment uncovers hidden layers of the human psyche.",
      "Penned by Badal Sircar, the play follows the unexpected meeting of a husband, a wife, and an enigmatic old man in an isolated dwelling. What initially appears to be a chance encounter gradually evolves into an intense exchange of ideas, emotions, and beliefs. As the night progresses, the boundaries between reality and metaphor begin to dissolve, compelling the characters to confront their fears, prejudices, desires, and the emptiness that often lies beneath the routines of everyday life.",
      "Through this deceptively simple narrative, Sircar examines the complexities of modern existence, questioning society's growing alienation, the fragility of human relationships, and the pursuit of material comforts at the expense of inner fulfilment. The old man emerges not merely as a character but as a symbolic presence—a guide, a conscience, and perhaps even a reflection of the wisdom that modern humanity has forgotten to seek.",
      "Rather than offering definitive answers, Saari Raat invites its audience to engage in quiet contemplation. It encourages us to recognize that life's most profound transformations seldom occur through extraordinary events, but through moments of reflection, empathy, and genuine human connection.",
      "More than a theatrical performance, Saari Raat is an immersive meditation on the human condition. It reminds us that every long night carries within it the possibility of awakening, and that the greatest discoveries are often made not in the world around us, but within ourselves. Long after the curtain falls, the play continues to resonate, leaving the audience with questions that are deeply personal, profoundly universal, and enduringly relevant."
    ],
    directorsNoteFull: [
